STORY_PROMPT = """
                ...
                - Each node should have 2-3 options except for ending nodes (which should have no options)
                ...
                - Ending nodes (isEnding: true) should NOT have an options array
